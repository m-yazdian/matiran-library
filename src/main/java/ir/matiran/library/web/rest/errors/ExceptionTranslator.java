package ir.matiran.library.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ir.matiran.library.service.EmailAlreadyUsedException ||
            ex instanceof ir.matiran.library.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ir.matiran.library.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "ir.matiran.library");
    }
}
